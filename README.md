...
**Disclaimer: I used ChatGPT to help design some of this code. I have found the script to work perfectly, but you may verify that the script does what you want it to do relying on results produced by these scripts.**
